...
+ (void)showLoading:(NSMutableAttributedString *)attributedLoading images:(NSArray*)images backgroundColor:(UIColor*)backgroundColor
{
    ...
    int padding = 0;
    padding = [[UIApplication sharedApplication] statusBarFrame].size.height;
    
    CGRect frame=CGRectMake(LSStatusBarHUDLeftMargin, (44- LSStatusBarHUDImageWidth)/2+padding,LSStatusBarHUDImageWidth, LSStatusBarHUDImageWidth);
    ...
    label.frame=CGRectMake(x, padding,LSStatusBarHUDScreenWidth-x, 44);
...
+(void)showMessage:(NSMutableAttributedString *)attributedMessage backgroundColor:(UIColor *)backgroundColor
{
    ...
    label.frame=CGRectMake(0, padding,LSStatusBarHUDScreenWidth, 44);
...
+(instancetype)createWindowWithAutoHide:(BOOL)autoHide
{
    ...
    hud.frame=CGRectMake(0, -padding, LSStatusBarHUDScreenWidth, padding+44);
    hud.hidden=NO;
    //        hud.lastHUD=last;
