...
//  schoolOnLine
//
//  Created by panerly on 2019/12/31.
...
@implementation PTimer

+ (PTimer *)sharedInstance{
    static PTimer *_gcdTimer = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken, ^{
        _gcdTimer = [[PTimer alloc] init];
    });
    return _gcdTimer;
}
...
- (instancetype)init {
    ...
    if (self) {
        ...
        dispatch_queue_t queue = dispatch_queue_create("com.PTimer.queue", attr);
        _queue = queue;
